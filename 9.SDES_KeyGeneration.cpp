...
void keyGenerate(string key) {
    ...
    string combined = left_lcs1 + right_lcs1;
    string key1 = p8Permute(combined);
    cout << key1 << endl;
    ...
    string key2 = p8Permute(combined2);
    cout << key2 << endl;
}
